...
export default [
  ...
  //   label: 'Values',
  //   key: 'values',
  //   // tooltip: 'The bodychart button values that can be picked for this field. Values are text submitted with the form data. Labels are text that appears next to the bodychart buttons on the form.',
  //   weight: 10,
  //   reorder: false,
  //   defaultValue: [
  //     { label: 'statelist', value: 'Brain' },
  //     { label: 'condition', value: 'Acoustic Neuroma (Vestibular Schwannoma)' }
  //   ],
  //   components: [
  //     {
  //       label: 'Label',
